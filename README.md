...
![Git](https://img.shields.io/badge/Git-F05032?style=for-the-badge&logo=git&logoColor=white)
  ...
  Languages: javascript(ES6), Sass, Bootstrap, SQL, jQuery, CSS, HTML, Markdown, ReactJS, React Hooks, React Native,
  
  Computer OS : macOS Catalina, Microsoft Windows
  
  Tools:  Redux, Heroku, Netlify, Git, Regex, npm, Node.js, Redis, Express.js, MongoDB, Mongo Atlas, Jest, TDD, Socket.io, Auth0
